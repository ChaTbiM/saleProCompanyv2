        ...
        <div id="receipt-data">
            ...
            <table>
                <tbody>
                    ...
                    @endphp
                    <tr>
                        <td colspan="2">{{$service_name}}<br>{{$service_sale_data->qty}} x
                            {{number_format((float)($service_sale_data->total / $service_sale_data->qty), 2, '.', '')}}
                        </td>
                        <td style="text-align:right;vertical-align:bottom">
                            {{number_format((float)$service_sale_data->total, 2, '.', '')}}</td>
                    </tr>
                    @endforeach
                </tbody>
                <tfoot>
                    <tr>
                        ...
                        <th style="text-align:right">{{number_format((float)$lims_sale_data->total_price, 2, '.', '')}}
                        </th>
                    </tr>
                    @if($lims_sale_data->order_tax)
                    <tr>
                        <th colspan="2">{{trans('file.Order Tax')}}</th>
                        <th style="text-align:right">{{number_format((float)$lims_sale_data->order_tax, 2, '.', '')}}
                        </th>
                    </tr>
                    @endif
                    ...
                    <tr>
                        ...
                        <th style="text-align:right">{{number_format((float)$lims_sale_data->grand_total, 2, '.', '')}}
                        </th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th class="centered" colspan="3">{{trans('file.In Words')}}:
                            ...
                            <span>{{$general_setting->currency}}</span></th>
                        @endif
                    </tr>
                </tfoot>
            </table>
            <table>
                <tbody>
                    ...
                    <tr style="background-color:#ddd;">
                        <td style="padding: 5px;width:30%">{{trans('file.Paid By')}}: {{$payment_data->paying_method}}
                        </td>
            ...
            {{trans('file.Developed By')}} DZ-DEV</strong></small>
        </div> -->
        </div>
    </div>
