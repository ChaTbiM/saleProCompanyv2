                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Service Name')}} *</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.service category')}} *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Service Tax')}}</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <p class="italic">{{trans('file.Featured service will be displayed in POS')}}</p>
                                    </div> 
                                </div>                             
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('file.Service Image')}}</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.You can upload multiple image. Only .jpeg, .jpg, .png, .gif file can be uploaded. First image will be base image.')}}"></i>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>{{trans('file.Service Details')}}</label>
