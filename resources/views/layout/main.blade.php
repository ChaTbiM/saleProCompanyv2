    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          @if (!empty(checkModule(1)) && ($index_permission_active || $print_barcode_active || $stock_count_active ||
          ...
          <?php  
              ...
              ?>
          @if( ($index_permission_active || $add_permission_active) && !empty(checkModule(12)))
          ...
          <?php 
                  ...
                  // $module_active =
              ?>
          @if(($index_permission_active ||$add_permission_active ) && !empty(checkModule(2)) )
          ...
          <?php 
              ...
              ?>
          @if((checkModule(3) !== null ) && ($index_permission_active || $gift_card_permission_active ||
          ...
          <?php 
              ...
              ?>
          @if(($index_permission_active || $add_permission_active || 1 ) && !empty(checkModule(4)) )
          ...
          <?php 
              ...
              ?>
          @if(($index_permission_active || $add_permission_active ) && !empty(checkModule(5)))
          ...
          <?php 
              ...
              ?>
          @if(($index_permission_active || $add_permission_active) && !empty(checkModule(6)))
          ...
          <?php 
                  ...
                  ?>
          @if(!empty(checkModule(7)) && ($purchase_return_permission_active || $return_permission_active))
          <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="return" class="collapse list-unstyled ">
              ...
              @if(!empty($return_permission_active))
              <li id="sale-return-menu"><a href="{{route('return-sale.index')}}">{{trans('file.Sale')}}</a></li>
              @endif
              @if(!empty($purchase_return_permission_active))
          ...
          <?php 
              ...
              ?>
          @if(!empty(checkModule(8)) && ($index_permission_active || $money_transfer_permission_active ||
          ...
          <?php 
              ...
              ?>
          @if(!empty(checkModule(9)) && ($department_active || $index_employee_active || $attendance_active ||
          $payroll_active ))
      ...
      <div class="container-fluid">
        <div class="navbar-holder d-flex align-items-center justify-content-between">
          ...
          <span class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="https://akeedgroups.com/home"><i
            class="dripicons-home"></i><span> {{ trans('file.home') }} </span></a></span>
            ...
            <li class="nav-item">
              ...
              <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                <li class="notifications">
                  <a href="{{route('report.qtyAlert')}}" class="btn btn-link"> {{$alert_product}} product exceeds alert
                    quantity</a>
                </li>
              </ul>
            </li>
