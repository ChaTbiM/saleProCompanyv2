...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            ...
            <?php echo Form::open(['route' => 'report.service', 'method' => 'post']); ?>
    ...
    <div class="table-responsive mb-4">
        <table id="report-table" class="table table-hover">
            ...
            <tbody>
                <?php if(!empty($lims_service_all)): ?>
                <?php $__currentLoopData = $lims_service_all; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                    $sold_qty = collect(DB::select('select * from services_sales where service_id = ?', [$service->id]))->sum('qty');
                    $sold_total = collect(DB::select('select * from services_sales where service_id = ?', [$service->id]))->sum('total');
                ?>
                <tr>
                    <td><?php echo e($key); ?></td>
                    <td><?php echo e($service->name); ?></td>
                    
                    <td><?php echo e(number_format((float)$sold_total, 2, '.', '')); ?></td>
...
<script type="text/javascript">
    ...
    $("ul#report #service-report-menu").addClass("active");
 ...
 // 
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            console.log(dt_selector,'dt_selector');
