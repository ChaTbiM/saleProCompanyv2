...
<body>
    ...
    <div style="max-width:400px;margin:0 auto">
            ...
            <table>
                <tr>
                    ...
                    <td><button onclick="window.print();" class="btn btn-primary"><i class="dripicons-print"></i>
                            <?php echo e(trans('file.Print')); ?></button></td>
                </tr>
            </table>
            <br>
        </div>
        ...
        <div id="receipt-data">
            ...
            <table>
                <tbody>
                    <?php $__currentLoopData = $lims_service_sale_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service_sale_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    $lims_service_data = \App\Service::find($service_sale_data->service_id);
                    $service_name = $lims_service_data->name;
                    ?>
                    <tr>
                        <td colspan="2"><?php echo e($service_name); ?><br><?php echo e($service_sale_data->qty); ?> x
                            <?php echo e(number_format((float)($service_sale_data->total / $service_sale_data->qty), 2, '.', '')); ?>

                        </td>
                        <td style="text-align:right;vertical-align:bottom">
                            <?php echo e(number_format((float)$service_sale_data->total, 2, '.', '')); ?></td>
                    </tr>
                ...
                <tfoot>
                    <tr>
                        ...
                        <th style="text-align:right"><?php echo e(number_format((float)$lims_sale_data->total_price, 2, '.', '')); ?>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right"><?php echo e(number_format((float)$lims_sale_data->order_tax, 2, '.', '')); ?>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right">
                            <?php echo e(number_format((float)$lims_sale_data->order_discount, 2, '.', '')); ?></th>
                    </tr>
                    <?php endif; ?>
                    ...
                    <tr>
                        ...
                        <th style="text-align:right">
                            <?php echo e(number_format((float)$lims_sale_data->shipping_cost, 2, '.', '')); ?></th>
                    </tr>
                    <?php endif; ?>
                    <tr>
                        <th colspan="2"><?php echo e(trans('file.grand total')); ?></th>
                        <th style="text-align:right"><?php echo e(number_format((float)$lims_sale_data->grand_total, 2, '.', '')); ?>
                    ...
                    <tr>
                        ...
                        <th class="centered" colspan="3"><?php echo e(trans('file.In Words')); ?>:
                            <span><?php echo e($general_setting->currency); ?></span>
                            <span><?php echo e(str_replace("-"," ",$numberInWords)); ?></span></th>
                        <?php else: ?>
                        <th class="centered" colspan="3"><?php echo e(trans('file.In Words')); ?>:
                            <span><?php echo e(str_replace("-"," ",$numberInWords)); ?></span>
                            <span><?php echo e($general_setting->currency); ?></span></th>
                        <?php endif; ?>
                    </tr>
                </tfoot>
            </table>
            <table>
                <tbody>
                    ...
                    <tr style="background-color:#ddd;">
                        <td style="padding: 5px;width:30%"><?php echo e(trans('file.Paid By')); ?>: <?php echo e($payment_data->paying_method); ?>
                    ...
                    <tr>
                        <td class="centered" colspan="3">
                            <?php echo e(trans('file.Thank you for shopping with us. Please come again')); ?></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </tbody>
            </table>
            ...
            <?php echo e(trans('file.Developed By')); ?> DZ-DEV</strong></small>
        </div> -->
        </div>
    </div>
