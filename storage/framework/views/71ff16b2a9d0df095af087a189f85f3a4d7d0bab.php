...
<section>
    <div class="container-fluid">
        <?php if(in_array("products-add", $all_permission)): ?>
            <a href="<?php echo e(route('services.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(__('file.add_product')); ?></a>
...
<div id="importProduct" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <?php echo Form::open(['route' => 'service.import', 'method' => 'post', 'files' => true]); ?>
...
<script>
    ...
    function productDetails(product, imagedata) {
        ...
        htmltext = '<p><strong><?php echo e(trans("file.name")); ?>: </strong>'+product[0]+'</p><p><strong><?php echo e(trans("file.Code")); ?>: </strong>'+product[1]+ '</p><p><strong><?php echo e(trans("file.category")); ?>: </strong>'+product[2]+'</p><p><strong><?php echo e(trans("file.Unit")); ?>: </strong>'+product[3]+'</p><p><strong><?php echo e(trans("file.Price")); ?>: </strong>'+product[5]+'</p><p><strong><?php echo e(trans("file.Tax")); ?>: </strong>'+product[6]+'</p><p><strong><?php echo e(trans("file.Tax Method")); ?> : </strong>'+product[7]+'</p><p><strong><?php echo e(trans("file.Service Details")); ?>: </strong></p>'+product[8];
