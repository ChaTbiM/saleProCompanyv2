...
<head>
  ...
  <script type="text/javascript" src="<?php echo asset('public/vendor/bootstrap-toggle/js/bootstrap-toggle.min.js') ?>">
  </script>
    ...
    <div class="side-navbar-wrapper">
      ...
      <div class="main-menu">
        <ul id="side-main-menu" class="side-menu list-unstyled">
          ...
          <?php if(!empty(checkModule(1)) && ($index_permission_active || $print_barcode_active || $stock_count_active ||
          $adjustment_active ||$add_permission_active) ): ?>
          <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="product" class="collapse list-unstyled ">
              ...
              <li id="printBarcode-menu"><a href="<?php echo e(route('product.printBarcode')); ?>"><?php echo e(__('file.print_barcode')); ?></a>
              </li>
              <?php endif; ?>
          ...
          <?php  
              ...
              ?>
          <?php if( ($index_permission_active || $add_permission_active) && !empty(checkModule(12))): ?>
          <li><a href="#service" aria-expanded="false" data-toggle="collapse"> <i
                class="dripicons-list"></i><span><?php echo e(__('file.service')); ?></span><span></a>
            <ul id="service" class="collapse list-unstyled ">
              <li id="category-menu"><a href="<?php echo e(route('service_category.index')); ?>"><?php echo e(__('file.service categories')); ?></a>
              </li>
              <?php if(!empty($index_permission_active)): ?>
              <li id="service-list-menu"><a href="<?php echo e(route('services.index')); ?>"><?php echo e(__('file.service list')); ?></a></li>
              <?php endif; ?>
              <?php if(!empty($add_permission_active)): ?>
              <li id="service-create-menu"><a href="<?php echo e(route('services.create')); ?>"><?php echo e(__('file.add service')); ?></a></li>
              <?php endif; ?>
            </ul>
          </li>
          <?php endif; ?>
          <?php 
                  ...
                  // $module_active =
              ?>
          <?php if(($index_permission_active ||$add_permission_active ) && !empty(checkModule(2)) ): ?>
          <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="purchase" class="collapse list-unstyled ">
              <li id="purchase-list-menu"><a href="<?php echo e(route('purchases.index')); ?>"><?php echo e(trans('file.Purchase List')); ?></a>
              </li>

              <?php if(!empty($add_permission_active)): ?>
              <li id="purchase-create-menu"><a href="<?php echo e(route('purchases.create')); ?>"><?php echo e(trans('file.Add Purchase')); ?></a>
              </li>
              <li id="purchase-import-menu"><a
                  href="<?php echo e(url('purchases/purchase_by_csv')); ?>"><?php echo e(trans('file.Import Purchase By CSV')); ?></a></li>
              <?php endif; ?>
            </ul>
          </li>
          ...
          <?php 
              ...
              ?>
          <?php if((checkModule(3) !== null ) && ($index_permission_active || $gift_card_permission_active ||
          $coupon_permission_active || 1) ): ?>
          <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="sale" class="collapse list-unstyled ">
              ...
              <li id="sale-import-menu"><a href="<?php echo e(url('sales/sale_by_csv')); ?>"><?php echo e(trans('file.Import Sale By CSV')); ?></a>
              </li>
              <?php endif; ?>
              <?php endif; ?>
          ...
          <?php 
              ...
              ?>
          <?php if(($index_permission_active || $add_permission_active || 1 ) && !empty(checkModule(4)) ): ?>
          ...
          <?php 
              ...
              ?>
          <?php if(($index_permission_active || $add_permission_active ) && !empty(checkModule(5))): ?>
          <li><a href="#quotation" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="quotation" class="collapse list-unstyled ">
              <?php if(!empty($index_permission_active)): ?>
              <li id="quotation-list-menu"><a href="<?php echo e(route('quotations.index')); ?>"><?php echo e(trans('file.Quotation List')); ?></a>
              </li>
              <?php endif; ?>
              <?php if(!empty($add_permission_active)): ?>
          ...
          <?php 
              ...
              ?>
          <?php if(($index_permission_active || $add_permission_active) && !empty(checkModule(6))): ?>
          <li><a href="#transfer" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="transfer" class="collapse list-unstyled ">
              ...
              <li id="transfer-list-menu"><a href="<?php echo e(route('transfers.index')); ?>"><?php echo e(trans('file.Transfer List')); ?></a>
              </li>
              <?php endif; ?>
              <?php if(!empty($add_permission_active)): ?>
              <li id="transfer-create-menu"><a href="<?php echo e(route('transfers.create')); ?>"><?php echo e(trans('file.Add Transfer')); ?></a>
              </li>
              <li id="transfer-import-menu"><a
                  href="<?php echo e(url('transfers/transfer_by_csv')); ?>"><?php echo e(trans('file.Import Transfer By CSV')); ?></a></li>
              <?php endif; ?>
            </ul>
          </li>
          <?php endif; ?>
          <?php 
                    ...
                    $return_permission_active = getPermissionActive("returns-index");
                    $purchase_return_permission_active = getPermissionActive("purchase-return-index");
                  ?>
          <?php if(!empty(checkModule(7)) && ($purchase_return_permission_active || $return_permission_active)): ?>
          <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i
                class="dripicons-archive"></i><span><?php echo e(trans('file.return')); ?></span></a>
            <ul id="return" class="collapse list-unstyled ">

              <?php if(!empty($return_permission_active)): ?>
              <li id="sale-return-menu"><a href="<?php echo e(route('return-sale.index')); ?>"><?php echo e(trans('file.Sale')); ?></a></li>
              <?php endif; ?>
              <?php if(!empty($purchase_return_permission_active)): ?>
              <li id="purchase-return-menu"><a href="<?php echo e(route('return-purchase.index')); ?>"><?php echo e(trans('file.Purchase')); ?></a>
              </li>
              <?php endif; ?>
            </ul>
          </li>
          ...
          <?php 
              ...
              ?>
          <?php if(!empty(checkModule(8)) && ($index_permission_active || $money_transfer_permission_active ||
          $balance_sheet_permission_active || $account_statement_permission_active)): ?>
          <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="account" class="collapse list-unstyled ">
              ...
              <li id="account-statement-menu"><a id="account-statement" href=""><?php echo e(trans('file.Account Statement')); ?></a>
              </li>
              <?php endif; ?>
            </ul>
          </li>
          ...
          <?php 
              ...
              ?>
          <?php if(!empty(checkModule(9)) && ($department_active || $index_employee_active || $attendance_active ||
          $payroll_active )): ?>
          ...
          <?php 
                  $users_index_permission_active = getPermissionActive("user-index");
                  $users_add_permission_active = getPermissionActive("users-add");
                  $customers_index_permission_active = getPermissionActive("customers");
                  $customers_add_permission_active = getPermissionActive("customers-add");
                  $billers_index_permission_active = getPermissionActive("billers-index");
                  $billers_add_permission_active = getPermissionActive("billers-add");
                  $suppliers_index_permission_active = getPermissionActive("suppliers-index");
                  $suppliers_add_permission_active = getPermissionActive("suppliers-add");

                  ?>

          <?php if(!empty(checkModule(10)) &&
          (
          $users_index_permission_active || $users_add_permission_active
          || $customers_index_permission_active || $customers_add_permission_active
          || $billers_index_permission_active || $billers_add_permission_active
          || $suppliers_index_permission_active || $suppliers_add_permission_active
          ) ): ?>
          ...
          $profit_loss_active || $best_seller_active || $best_seller_service_active
          ...
          <li><a href="#report" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="report" class="collapse list-unstyled ">
              ...
              <?php endif; ?>
              <?php if(!empty($salesman_report_active)): ?>
              <li id="salesman-report-menu">
                <?php echo Form::open(['route' => 'report.salesman', 'method' => 'post', 'id' => 'salesman-report-form']); ?>

                <input type="hidden" name="start_date" value="1988-04-18" />
                <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                <input type="hidden" name="warehouse_id" value="0" />
                <a id="salesman-report-link" href=""><?php echo e(trans('file.Salesman Report')); ?></a>
                <?php echo Form::close(); ?>

              </li>
              <?php endif; ?>
              <?php if(!empty($service_provider_report_active)): ?>
              <li id="service_provider-report-menu">
                <?php echo Form::open(['route' => 'report.service_provider', 'method' => 'post', 'id' => 'service_provider-report-form']); ?>

                <input type="hidden" name="start_date" value="1988-04-18" />
                <input type="hidden" name="end_date" value="<?php echo e(date('Y-m-d')); ?>" />
                <input type="hidden" name="warehouse_id" value="0" />
                <a id="service_provider-report-link" href=""><?php echo e(trans('file.Service Provider Report')); ?></a>
                <?php echo Form::close(); ?>
          ...
          <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i
            ...
            <ul id="setting" class="collapse list-unstyled ">
              ...
              <?php if($user_role_id == 3 ): ?>
                ...
                <li id="general-setting-menu"><a href="<?php echo e(route('setting.general')); ?>"><?php echo e(trans('file.General Setting')); ?></a>
                </li>
    ...
    <nav class="navbar">
      <div class="container-fluid">
        <div class="navbar-holder d-flex align-items-center justify-content-between">
          ...
          <span class="nav-item"><a class="dropdown-item btn-pos btn-sm" href="https://akeedgroups.com/home"><i
            class="dripicons-home"></i><span> <?php echo e(trans('file.home')); ?> </span></a></span>
            ...
            <li class="nav-item">
              <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true"
                aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-bell"></i><span
                  class="badge badge-danger"><?php echo e($alert_product); ?></span>
              </a>
              <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                <li class="notifications">
                  <a href="<?php echo e(route('report.qtyAlert')); ?>" class="btn btn-link"> <?php echo e($alert_product); ?> product exceeds alert
                    quantity</a>
                </li>
              </ul>
            </li>
              ...
              <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                ...
                <li>
                  <a onclick="return confirm('Are you sure want to delete? If you do this all of your data will be lost.')"
                    ...
                    <?php echo e(trans('file.Empty Database')); ?></a>
                </li>
                <?php endif; ?>
                <li>
      ...
      <div role="document" class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small>
            </p>
